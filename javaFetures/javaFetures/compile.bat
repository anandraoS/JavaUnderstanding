...
echo.
echo [1/6] Compiling ListExamples...
javac collections\ListExamples.java

echo [2/6] Compiling SetExamples...
javac collections\SetExamples.java

echo [3/6] Compiling MapExamples...
javac collections\MapExamples.java

echo [4/6] Compiling QueueExamples...
javac collections\QueueExamples.java

echo [5/6] Compiling CollectionUtilities...
javac collections\CollectionUtilities.java

echo [6/6] Compiling AdvancedCollectionConcepts...
